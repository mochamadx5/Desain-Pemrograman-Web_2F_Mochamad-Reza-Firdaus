...
<form method="POST" action="<?php echo $form_action; ?>">
    ...
    <div class="form-group">
        ...
        <input type="number" name="salary" class="form-input" value="<?php echo $is_edit ? $employee['salary'] : ''; ?>" required min="0" max="99999999" step="0.01" placeholder="Contoh: 5000000">
