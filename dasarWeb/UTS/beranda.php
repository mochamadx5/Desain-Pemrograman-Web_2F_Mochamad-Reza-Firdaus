  ...
  <div class="container">
    ...
    <main class="main-content">
      <section class="welcome-section">
        ...
        <p>Akses cepat ke informasi akademik, nilai, jadwal kuliah, dan layanan mahasiswa.</p>
      </section>
      ...
      <section class="info-grid">
        ...
        <div class="info-card">
          ...
          <button class="btn-primary">Isi KRS</button>
        </div>
        <div class="info-card">
          <h3>LMS</h3>
    ...
    <footer class="footer">
      <p>© 2025 Sistem Informasi Akademik - Politeknik Negeri Malang</p>
    </footer>
  </div>
</body>
</html>
